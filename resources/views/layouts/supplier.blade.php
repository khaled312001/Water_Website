...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم المورد - سلسبيل مكة')</title>
...
<body>
    ...
    <div class="supplier-sidebar" id="supplierSidebar">
        <div class="sidebar-header">
            ...
            <h3><i class="fas fa-store me-2"></i>سلسبيل مكة</h3>
        ...
        <div class="sidebar-menu">
            <nav class="nav flex-column">
                ...
                <a href="{{ route('supplier.products') }}" class="nav-link {{ request()->routeIs('supplier.products') ? 'active' : '' }}">
                ...
                <a href="{{ route('supplier.earnings') }}" class="nav-link {{ request()->routeIs('supplier.earnings') ? 'active' : '' }}">
        ...
        <div class="sidebar-footer">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <small class="d-block opacity-50">مورد</small>
                </div>
    ...
    <div class="supplier-main">
        ...
        <header class="supplier-header">
            ...
            <div class="header-right">
                <a href="{{ route('home') }}" class="btn btn-outline-success me-3" title="الذهاب إلى الموقع">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelector('.supplier-content').classList.add('fade-in');
        ...
        // addNotificationBadge(document.querySelector('a[href*="products"]'), 3);
    </script>
