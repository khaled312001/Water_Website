...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم العميل - سلسبيل مكة')</title>
...
<body>
    ...
    <div class="customer-sidebar" id="customerSidebar">
        <div class="sidebar-header">
            ...
            <h3><i class="fas fa-user me-2"></i>سلسبيل مكة</h3>
        ...
        <div class="sidebar-footer">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <small class="d-block opacity-50">عميل</small>
                </div>
    ...
    <div class="customer-main">
        ...
        <header class="customer-header">
            ...
            <div class="header-right">
                <a href="{{ route('home') }}" class="btn btn-outline-info me-3" title="الذهاب إلى الموقع">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelector('.customer-content').classList.add('fade-in');
        ...
        // addNotificationBadge(document.querySelector('a[href*="cart"]'), 3);
    </script>
